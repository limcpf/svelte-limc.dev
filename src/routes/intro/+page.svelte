...
<svelte:head>
    <title>{`임싱싱 소개페이지 | 싱싱한 코딩`}</title>
    <meta property="og:url" content="https://limc.dev/intro">
    <meta property="og:title" content="임싱싱 소개페이지 | 싱싱한 코딩">
</svelte:head>
<div>
    {@html htmlContent}
</div>
